      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-8 px-6 bg-gray-100 w-full max-w-full">
        ...
        >
          <img
            ...
            className="w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 lg:w-[442px] lg:h-[394px]"
          />
        </div>
        ...
        <div
          ...
          data-aos="fade-left"
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-tertiary mb-6 md:mb-4 tracking-wide">
            We are Paws and Promises
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#379777] mb-4 text-justify leading-relaxed tracking-wider">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#379777] text-justify leading-relaxed tracking-wider">
